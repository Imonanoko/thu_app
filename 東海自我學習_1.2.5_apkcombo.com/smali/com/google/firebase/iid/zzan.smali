...
# static fields
.field private static zzcl:Lcom/google/firebase/iid/zzan;


# instance fields
.field private final zzcm:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzcn:Ljava/lang/Boolean;

.field final zzco:Ljava/util/Queue;
...
.field private final zzcp:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzcm:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzcn:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzco:Ljava/util/Queue;

    new-instance v0, Ljava/util/ArrayDeque;

    invoke-direct {v0}, Ljava/util/ArrayDeque;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzan;->zzcp:Ljava/util/Queue;
...
.method public static declared-synchronized zzad()Lcom/google/firebase/iid/zzan;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/iid/zzan;->zzcl:Lcom/google/firebase/iid/zzan;
    ...
    sput-object v1, Lcom/google/firebase/iid/zzan;->zzcl:Lcom/google/firebase/iid/zzan;
...
.method private final zzb(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzcm:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/iid/zzan;->zzcm:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :cond_3
    :goto_0
    iget-object v2, p0, Lcom/google/firebase/iid/zzan;->zzcm:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v2

    :try_start_1
    iget-object v3, p0, Lcom/google/firebase/iid/zzan;->zzcm:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_5
    :try_start_2
    iget-object v1, p0, Lcom/google/firebase/iid/zzan;->zzcn:Ljava/lang/Boolean;
    ...
    :cond_a
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzcn:Ljava/lang/Boolean;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzcp:Ljava/util/Queue;

    goto :goto_3

    :cond_5
    iget-object v0, p0, Lcom/google/firebase/iid/zzan;->zzco:Ljava/util/Queue;
    ...
    invoke-direct {p0, p1, p3}, Lcom/google/firebase/iid/zzan;->zzb(Landroid/content/Context;Landroid/content/Intent;)I
...
.method public final zzae()Landroid/content/Intent;
    .locals 1
