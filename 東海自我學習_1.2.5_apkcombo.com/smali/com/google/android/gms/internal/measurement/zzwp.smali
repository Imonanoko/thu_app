...
.method private constructor <init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    new-instance p1, Lcom/google/android/gms/internal/measurement/zzwq;

    const/4 p2, 0x0

    invoke-direct {p1, p0, p2}, Lcom/google/android/gms/internal/measurement/zzwq;-><init>(Lcom/google/android/gms/internal/measurement/zzwp;Landroid/os/Handler;)V

    iput-object p1, p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmv:Landroid/database/ContentObserver;
...
.method public static zza(Landroid/content/ContentResolver;Landroid/net/Uri;)Lcom/google/android/gms/internal/measurement/zzwp;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/internal/measurement/zzwp;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V

    sget-object p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmt:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {p0, p1, v0}, Ljava/util/concurrent/ConcurrentHashMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/google/android/gms/internal/measurement/zzwp;

    if-nez p0, :cond_0

    iget-object p0, v0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmu:Landroid/content/ContentResolver;

    iget-object p1, v0, Lcom/google/android/gms/internal/measurement/zzwp;->uri:Landroid/net/Uri;

    const/4 v1, 0x0

    iget-object v2, v0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmv:Landroid/database/ContentObserver;
...
.method private final zzrv()Ljava/util/Map;
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmu:Landroid/content/ContentResolver;

    iget-object v2, p0, Lcom/google/android/gms/internal/measurement/zzwp;->uri:Landroid/net/Uri;

    sget-object v3, Lcom/google/android/gms/internal/measurement/zzwp;->zzbna:[Ljava/lang/String;
...
.method private final zzrw()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmy:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmz:Ljava/util/List;
    ...
    check-cast v2, Lcom/google/android/gms/internal/measurement/zzwr;

    invoke-interface {v2}, Lcom/google/android/gms/internal/measurement/zzwr;->zzrx()V
...
.method public final zzru()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmw:Ljava/lang/Object;
    ...
    :try_start_0
    iput-object v1, p0, Lcom/google/android/gms/internal/measurement/zzwp;->zzbmx:Ljava/util/Map;
