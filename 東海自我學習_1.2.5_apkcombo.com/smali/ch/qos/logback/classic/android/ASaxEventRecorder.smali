...
.method private endElement(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {p0, p1, v0, v0}, Lch/qos/logback/classic/android/ASaxEventRecorder;->endElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method private startElement(Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-virtual {p0, v2, v0, v0, v1}, Lch/qos/logback/classic/android/ASaxEventRecorder;->startElement(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/xml/sax/Attributes;)V
...
.method public recordEvents(Lorg/xml/sax/InputSource;)Ljava/util/List;
    ...
    :try_start_0
    new-instance v0, Lbrut/androlib/res/decoder/AXmlResourceParser;

    invoke-direct {v0, p1}, Lbrut/androlib/res/decoder/AXmlResourceParser;-><init>(Ljava/io/InputStream;)V
    ...
    :cond_0
    :goto_0
    invoke-virtual {v0}, Lbrut/androlib/res/decoder/AXmlResourceParser;->next()I
    ...
    invoke-virtual {p0, v0, p1}, Lch/qos/logback/classic/android/ASaxEventRecorder;->addError(Ljava/lang/String;Ljava/lang/Throwable;)V
