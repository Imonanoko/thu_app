...
.method private getFileNameIncludingCompressionSuffix(Ljava/util/Date;I)Ljava/lang/String;
    ...
    iget-object p1, p1, Lch/qos/logback/core/rolling/TimeBasedRollingPolicy;->fileNamePattern:Lch/qos/logback/core/rolling/helper/FileNamePattern;
...
.method public isTriggeringEvent(Ljava/io/File;Ljava/lang/Object;)Z
    ...
    :cond_0
    iget v0, p0, Lch/qos/logback/core/rolling/SizeAndTimeBasedFNATP;->invocationCounter:I

    add-int/2addr v0, v5

    iput v0, p0, Lch/qos/logback/core/rolling/SizeAndTimeBasedFNATP;->invocationCounter:I

    iget v1, p0, Lch/qos/logback/core/rolling/SizeAndTimeBasedFNATP;->invocationMask:I
